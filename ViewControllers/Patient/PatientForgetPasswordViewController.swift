//
//  PatientForgetPasswordViewController.swift
//  IoRespiro2019
//
...
class PatientForgetPasswordViewController: UIViewController {
    ...
    func emailTFUI()
    {
        ...
        emailTextField.attributedPlaceholder = NSAttributedString(string: "Email",                                                                     attributes: [NSAttributedString.Key.foregroundColor: UIColor.patientThemeColor])
...
extension PatientForgetPasswordViewController
{
